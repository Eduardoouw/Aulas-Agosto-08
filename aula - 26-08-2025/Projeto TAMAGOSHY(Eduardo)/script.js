document.addEventListener('DOMContentLoaded', () => {
    ...
    const PET_STAGES = [
        { name: 'Ovo', image: 'images/capybara/egg.png', minAge: 0, maxAge: 1 },
        { name: 'Bebê', image: 'images/capybara/baby.png', minAge: 1, maxAge: 5 },
        { name: 'Criança', image: 'images/capybara/child.png', minAge: 5, maxAge: 15 },
        { name: 'Adolescente', image: 'images/capybara/teen.png', minAge: 15, maxAge: 30 },
        { name: 'Adulto', image: 'images/capybara/adult.png', minAge: 30, maxAge: Infinity }
    ];
